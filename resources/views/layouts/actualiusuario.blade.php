                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="company-detail new-account bg-light margin-right">
                                                        ...
                                                        <form autocomplete="null" class="login" method="post" action="{{ url('user/update') }}">
                                                            @csrf
                                                            <p class="form-row form-row-first input-required">
                                                                <label>
                                                                    <span class="first-letter">Nombre</span>
                                                            ...
                                                            <p class="form-row input-required">
                                                                <label>
                                                                    <span class="first-letter">Introduzca su contraseña actual</span>
                                                                    <span class="second-letter">*</span>
                                                                </label>
                                                                <input type="password" id="Address" name="mypassword"
                                                                    class="input-text">
                                                            </p>
                                                            <p class="form-row input-required">
                                                                <label>
                                                                    <span class="first-letter">Nueva Contraseña</span>
                                                                    <span class="second-letter">*</span>
                                                                </label>
                                                            ...
                                                            <p class="form-row input-required">
                                                                <label>
                                                                    <span class="first-letter">Confirma tu nueva contraseña</span>
                                                                    <span class="second-letter">*</span>
                                                                </label>
                                                                <input type="password" id="password1" name="password_confirmed"
                                                                    class="input-text">
                                                            </p>
                                                            <div class="clear"></div>
                                                            <input type="submit" 
