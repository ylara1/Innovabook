    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        <nav class="navbar-user-top full-reset">
            <ul class="list-unstyled full-reset">
                ...
                <li style="color:#fff; cursor:default;">
                    <span class="all-tittles">Rodrigo</span>
                </li>
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Innovabook <small>Nuevo libro</small></h1>
            </div>
        </div>
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                <li role="presentation"  class="active"><a href="admin.html">Formulario Libro</a></li>
            </ul>
        </div>
        <div class="container-fluid">
            <div class="row">
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form autocomplete="off" method="POST" action="{{ url('/store') }}">
                    @csrf
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <div class="group-material">
                                <input name="nombre" id="nombre" type="text" class="material-control tooltips-general" value="{{ old('nombre') }}" placeholder="Nombre libro" required="" maxlength="70" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,70}" data-toggle="tooltip" data-placement="top" title="Escribe el nombre del libro">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Nombre libro</label>
                            </div>
                           <div class="group-material">
                                <input type="text" id="descripcion" name="descripcion" value="{{ old('descripcion') }}" class="material-control tooltips-general input-check-user" placeholder="Descripción" required="" maxlength="250"  data-toggle="tooltip" data-placement="top" title="Escribe la descripcion">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Descripción</label>
                           </div>
                           <div class="group-material">
                            <input type="date" id="fehca" name="fecha" value="{{ old('fecha') }}" class="material-control tooltips-general input-check-user" placeholder="Fecha" required="" maxlength="20" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ]{1,20}" data-toggle="tooltip" data-placement="top" title="">
                            <span class="highlight"></span>
                            <span class="bar"></span>
                            <label>Fecha</label>
                       </div>
