    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Innovabook <small></small></h1>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                      <li class="active">Capitulo {{ $capitulos->n_cap }}</li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Capitulo {{ $capitulos->n_cap }}</div>
                
                <iframe width="800" height="700" src="{{ asset('/storage/documents/'.Auth::user()->id.'/'.$libros->Id_libro.'/'.$capitulos->link_cap) }}"  frameborder="0"></iframe>
