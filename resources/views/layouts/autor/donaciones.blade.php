    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Innovabook </h1>
            </div>
        </div>
         
        <div class="container-fluid" style="margin: 0 0 50px 0;">
            <h2 class="text-center" style="margin: 0 0 25px 0;">Donaciones recibidas</h2>
        </div>
                                    ...
                                    @if ($l->Id_user == Auth::user()->id)            
                                            <div class="media media-hover">
                                                ...
                                                <div class="media-body">
                                                    <h4 class="media-heading">{{ $lec->name }}</h4>
                                                    <div class="pull-left">
                                                        <strong>Libro: </strong>{{ $l->Nombre_libro }}<br>
                                                        <strong>Valor donado: </strong>{{ $d->Valor_donacion }}<br>
                                                    </div>
