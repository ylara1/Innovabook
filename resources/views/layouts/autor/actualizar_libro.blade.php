    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Innovabook <small>Actualizar libro</small></h1>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                      <li class="active">Actualizar {{ $libro->Nombre_libro }}</li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form method="POST" action="{{ url('mis_libros/update') }}" autocomplete="off">
                    @csrf
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <div class="group-material">
                                <input name="name" id="name" type="text" class="material-control tooltips-general" value="{{ $libro->Nombre_libro }}" placeholder="Nombre libro" required="" maxlength="70" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,70}" data-toggle="tooltip" data-placement="top" title="Escribe el nombre del libro">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Nombre del libro</label>
                                <input type="hidden" name="Id_libro" value="{{ $libro->Id_libro }}">
                                <input type="hidden" name="Id_user" value="{{ $libro->Id_user }}">
                            </div>
                            <div class="group-material">
                                <input type="text" name="descripcion" id="descripcion" value="{{ $libro->Descripción }}" class="material-control tooltips-general input-check-user" placeholder="Introduzca la descripción" required="" maxlength="250"  data-toggle="tooltip" data-placement="top" title="Introduzca la nueva descripción">
                                <span class="highlight"></span>
                                <span class="bar"></span>
